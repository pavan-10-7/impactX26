        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-24">
            {events.map((event, index) => (
              ...
              >
                <div className="relative p-6 sm:p-8 rounded-3xl bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-xl border border-white/10 hover:border-[#60A5FA]/50 transition-all duration-500 hover:shadow-2xl hover:shadow-[#60A5FA]/20 flex flex-col h-full">
                  {/* Hover Glow */}
                  ...
                  <div className="relative z-10 flex flex-col h-full">
                    <div className="flex flex-wrap-reverse items-start justify-between gap-4 mb-4">
                      <div>
                        <h2 className="text-3xl sm:text-4xl font-bold text-[#F8FAFC] mb-1 group-hover:text-[#60A5FA] transition-colors duration-300">
                          {event.name}
                        </h2>
                    ...
                    <p className="text-sm sm:text-base text-[#F8FAFC]/70 mb-8 leading-relaxed flex-grow">
                      {event.description}
                    </p>
                    ...
                    <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-8">
                      <div className="flex items-center gap-2 sm:gap-3">
                        <div className="p-1.5 sm:p-2 rounded-xl bg-gradient-to-br from-[#60A5FA]/20 to-[#3B82F6]/10 border border-white/10 shrink-0">
                          <Calendar className="w-4 h-4 sm:w-5 sm:h-5 text-[#60A5FA]" />
                        </div>
                        <div className="min-w-0">
                          <div className="text-[10px] sm:text-xs text-[#F8FAFC]/50 truncate">Date</div>
                          <div className="text-xs sm:text-sm text-[#F8FAFC] truncate">{event.date}</div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <div className="min-w-0">
                          <div className="text-[10px] sm:text-xs text-[#F8FAFC]/50 truncate">Participants</div>
                          <div className="text-xs sm:text-sm text-[#F8FAFC] truncate">{event.participants}</div>
                        </div>
                      </div>

                      <div className="flex items-center gap-2 sm:gap-3">
                        <div className="p-1.5 sm:p-2 rounded-xl bg-gradient-to-br from-[#60A5FA]/20 to-[#3B82F6]/10 border border-white/10 shrink-0">
                          <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-[#60A5FA]" />
                        </div>
                        <div className="min-w-0">
                          <div className="text-[10px] sm:text-xs text-[#F8FAFC]/50 truncate">Location</div>
                          <div className="text-xs sm:text-sm text-[#F8FAFC] truncate">{event.location}</div>
                        </div>
                      </div>

                      <div className="flex items-center gap-2 sm:gap-3">
                        <div className="p-1.5 sm:p-2 rounded-xl bg-gradient-to-br from-[#60A5FA]/20 to-[#3B82F6]/10 border border-white/10 shrink-0">
                          <Trophy className="w-4 h-4 sm:w-5 sm:h-5 text-[#60A5FA]" />
                        </div>
                        <div className="min-w-0">
                          <div className="text-[10px] sm:text-xs text-[#F8FAFC]/50 truncate">Prize Pool</div>
                          <div className="text-xs sm:text-sm text-[#F8FAFC] truncate">{event.prize}</div>
                        </div>
                      </div>
                    </div>

                    {/* View Details */}
                    <div className="flex items-center gap-2 text-[#60A5FA] group-hover:translate-x-2 transition-transform duration-300 mt-auto pt-2">
